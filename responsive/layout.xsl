<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/" mode="head">
        ...
        <script src="{$root}js/vs.js" type="text/javascript"></script>
        <script src="{$root}js/jquery.modal.min.js" type="text/javascript"></script>
        <script src="{$root}prism/prism.js" type="text/javascript"></script>
        <link href="{$root}css/jquery.modal.min.css" rel="stylesheet" media="all" />
        <link href="{$root}prism/prism.css" rel="stylesheet" media="all" />
