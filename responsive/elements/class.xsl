    ...
    <!-- Sidebar index for classes, interfaces, and traits -->
        ...
        <div class="btn-toolbar">
            <div class="btn-group visibility" data-toggle="buttons-checkbox">
                ...
                <button class="btn protected active" title="Show protected elements">Protected</button>
                <button class="btn private active" title="Show private elements">Private</button>
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">
              ...
              <li class="file">
                  ...
                  <span class='view-source' data-link="{$full_name}.html"><img src="{$root}img/icons/view_source.png" alt="View Source" border="0"/></span>
